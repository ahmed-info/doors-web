...
<main>
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4">انشاء قسم رئيسي</h1>
        ...
        <form action="{{route('dashboard.category.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6 mt-3">
                <div class="form-group mb-5">
                    <label for="title"><h4>اسم القسم</h4></label>
                    <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" placeholder="مثال: قسم الرجالي">
                    @error('title')
